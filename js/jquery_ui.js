...
!(function(t) {
    ...
    (V.widget = function(t, i, e) {
        ...
        return (
            ...
            (n.prototype = V.widget.extend(
                o, { widgetEventPrefix: (s && o.widgetEventPrefix) || t },
                a, { constructor: n, namespace: r, widgetName: t, widgetFullName: l }
            )),
            s ?
    ...
    (V.Widget.prototype = {
        ...
        option: function(t, e) {
            ...
            if ("string" == typeof t)
                if (((o = {}), (t = (i = t.split(".")).shift()), i.length)) {
                    for (
                        s = o[t] = V.widget.extend({}, this.options[t]), n = 0; n < i.length - 1; n++
                    )
                        (s[i[n]] = s[i[n]] || {}), (s = s[i[n]]);
        ...
        _classes: function(n) {
            ...
            return (
                (n = V.extend({ element: this.element, classes: this.options.classes || {} },
                    n
        ...
        V.fn.extend({
            effect: function() {
                ...
                function h(t) {
                    ...
                    (s.mode = l.shift()), !1 === V.uiBackCompat || o ?
                        "none" === s.mode ?
                        (e[r](), i()) :
    ...
    V.effects.define("blind", "hide", function(t, e) {
        ...
        V.effects.define("pulsate", "show", function(t, e) {
            var i = V(this),
                ...
                s = i.queue().length;
            for (
                (!n && i.is(":visible")) || (i.css("opacity", 0).show(), (r = 1)); l < o; l++
            )
    ...
    (V.ui.focusable = function(t, e) {
        ...
        return "area" === a ?
            ((s = (i = t.parentNode).name), !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) &&
                ...
                this._addClass("ui-autocomplete-input"),
                    ...
                    this._on(this.menu.element, {
                        ...
                        menufocus: function(t, e) {
                            ...
                            (i = e.item.data("ui-autocomplete-item")), !1 !== this._trigger("focus", t, { item: i }) &&
                                t.originalEvent &&
    ...
    function nt(t) {
        ...
        return t
            .on("mouseout", e, function() {
                V(this).removeClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") &&
                    V(this).removeClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") &&
    ...
    function ot() {
        V.datepicker._isDisabledDatepicker(
            ...
            (V(this)
                ...
                V(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") &&
                V(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") &&
                ...
                "input" !== (t = t.target || t).nodeName.toLowerCase() &&
                    ...
                    ((n = V.datepicker._getInst(t)),
                        ...
                        (V.datepicker._curInst.dpDiv.stop(!0, !0),
                            n &&
                            V.datepicker._datepickerShowing &&
                            V.datepicker._hideDatepicker(V.datepicker._curInst.input[0])), !1 !==
                        ...
                        (at(n.settings, i),
                            ...
                            n.dpDiv.css({
                                position: V.datepicker._inDialog && V.blockUI ?
                                    "static" :
                                    e ?
                                    "fixed" :
                                    "absolute",
                ...
                if ((m || (b += y + (!o && f && g ? "" : "&#xa0;")), !t.yearshtml))
                    if (((t.yearshtml = ""), o || !g))
                        ...
                        for (
                            ...
                            v +
                            "' data-handler='selectYear' data-event='change'>"; d <= p; d++
                        )
                            t.yearshtml +=
                            "<option value='" +
                            d +
        ...
        (V.fn.datepicker = function(t) {
            ...
            return ("string" == typeof t &&
                ...
                V.datepicker["_" + t + "Datepicker"].apply(
                    V.datepicker, [this[0]].concat(e)
                ) :
                this.each(function() {
                    "string" == typeof t
                        ?
                        V.datepicker["_" + t + "Datepicker"].apply(
                            V.datepicker, [this].concat(e)
                        ) :
    ...
    V.widget("ui.mouse", {
            ...
            _mouseDown: function(t) {
                if (!rt) {
                    ...
                    var e = this,
                        i = 1 === t.which,
                        s = !("string" != typeof this.options.cancel || !t.target.nodeName) &&
                ...
                o !== a && "HTML" !== o.tagName ?
                    ...
                    ((s.axis && "x" === s.axis) ||
                        ...
                        (t.pageX - V(a).scrollLeft() < s.scrollSensitivity ?
                            ...
                            s.scrollSensitivity &&
                            (n = V(a).scrollLeft(V(a).scrollLeft() + s.scrollSpeed)))), !1 !== n &&
                    V.ui.ddmanager &&
                    !s.dropBehaviour &&
            ...
            drag: function(t, e, i) {
                for (
                    var s,
                        ...
                        v = i.snapElements.length - 1; 0 <= v; v--
                )
                    (l =
                    ...
                    ("inner" !== d.snapMode &&
                        ...
                        ((s = Math.abs(h - m) <= p),
                            ...
                            }).left)), !i.snapElements[v].snapping &&
                        (s || n || o || a || u) &&
                        i.options.snap.snap &&
    ...
    V.widget("ui.resizable", V.ui.mouse, {
            ...
            _mouseDrag: function(t) {
                ...
                return (
                    ...
                    ((e = i.apply(this, [t, s, e])),
                        ...
                        (e = this._applyChanges()), !this._helper &&
            ...
            _proportionallyResize: function() {
                if (this._proportionallyResizeElements.length)
                    for (
                        var t, e = 0, i = this.helper || this.element; e < this._proportionallyResizeElements.length; e++
                    )
        ...
        V.ui.plugin.add("resizable", "ghost", {
            start: function() {
                ...
                t.ghost.css({
                    ...
                    t._addClass(t.ghost, "ui-resizable-ghost"), !1 !== V.uiBackCompat &&
    ...
    V.widget("ui.dialog", {
            ...
            _allowInteraction: function(t) {
                return (!!V(t.target).closest(".ui-dialog").length ||
                        ...
                        function() {
                            this.options &&
                                (!this.options.disabled &&
                                    ...
                                    (i = this._drop.call(this, e) || i), !this.options.disabled &&
                                    this.visible &&
                                    this.accept.call(
                                        this.element[0],
                ...
                n.options.refreshPositions && V.ui.ddmanager.prepareOffsets(n, o),
                    V.each(V.ui.ddmanager.droppables[n.options.scope] || [], function() {
                        ...
                        this.options.disabled ||
                            this.greedyChild ||
                            !this.visible ||
                            ((s = !(i = V.ui.intersect(n, this, this.options.tolerance, o)) &&
                                    this.isover ?
                                    "isout" :
                                    i && !this.isover ?
                                    "isover" :
        ...
        V.widget("ui.progressbar", {
            ...
            _constrainedValue: function(t) {
                return (
                    ...
                    "number" != typeof t && (t = 0), !this.indeterminate &&
        ...
        V.widget("ui.slider", V.ui.mouse, {
            ...
            _setOption: function(t, e) {
                ...
                switch (
                    ...
                    case "values":
                        for (
                            this._animateOff = !0, this._refreshValue(), i = s - 1; 0 <= i; i--
                        )
                            this._change(null, i);
                        this._animateOff = !1;
                        break;
                ...
                this._hasMultipleValues() ?
                    this.handles.each(function(t) {
                        ...
                        (h["horizontal" === r.orientation ? "left" : "bottom"] =
                            i + "%"),
                        V(this).stop(1, 1)[l ? "animate" : "css"](h, a.animate), !0 === r.options.range &&
                            ("horizontal" === r.orientation ?
                                (0 === t &&
                                    r.range
                                    .stop(1, 1)[l ? "animate" : "css"]({ left: i + "%" }, a.animate),
                                    1 === t &&
                    ...
                    ((t = this.value()),
                        ...
                        "horizontal" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ width: i + "%" }, a.animate),
                        "max" === o &&
                        "horizontal" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ width: 100 - i + "%" }, a.animate),
                        "min" === o &&
                        "vertical" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ height: i + "%" }, a.animate),
                        "max" === o &&
                        "vertical" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ height: 100 - i + "%" }, a.animate));
            },
            _handleEvents: {
                keydown: function(t) {
                    var e,
                        ...
                        case V.ui.keyCode.LEFT:
                            if (
                                (t.preventDefault(), !this._keySliding &&
                                    ((this._keySliding = !0),
                                        this._addClass(V(t.target), null, "ui-state-active"), !1 === this._start(t, n)))
                            )
                                return;
                    }
                    switch (
    ...
    V.widget("ui.spinner", {
            ...
            _start: function(t) {
                return (!(!this.spinning && !1 === this._trigger("start", t)) &&
