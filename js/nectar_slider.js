...
+     */
        ...
        _this.init = function(force, forceCalcSlides) {
            ...
            if (params.slidesPerView === "auto") {
                ...
                if (params.centeredSlides) {
                    if (isH) {
                        _this.wrapperLeft =
                            (containerSize - this.slides[0].getWidth(true)) / 2;
                        _this.wrapperRight =
                            (containerSize -
                        ...
                        _this.wrapperTop =
                            (containerSize - _this.slides[0].getHeight(true)) / 2;
                        _this.wrapperBottom =
                            (containerSize -
                                _this.slides[_this.slides.length - 1].getHeight(true)) /
                            2;
                    }
                }
                ...
                for (var i = 0; i < _this.slides.length; i++) {
                    ...
                    if (params.centeredSlides) {
                        var nextSlideWidth =
                            ...
                            0 :
                            _this.slides[i + 1].getWidth(true);
                        var nextSlideHeight =
                            i === _this.slides.length - 1 ?
                            0 :
                            _this.slides[i + 1].getHeight(true);
                        var nextSlideSize = isH ? nextSlideWidth : nextSlideHeight;
                        if (_slideSize > containerSize) {
                            for (
                                var j = 0; j <=
                                Math.floor(_slideSize / (containerSize + _this.wrapperLeft)); j++
                            ) {
                                if (j === 0) _this.snapGrid.push(slideLeft + _this.wrapperLeft);
                                else
                                    _this.snapGrid.push(
                                        slideLeft + _this.wrapperLeft + containerSize * j
                                    );
                            }
                        ...
                        if (_slideSize > containerSize) {
                            for (
                                var j = 0; j <= Math.floor(_slideSize / containerSize); j++
                            ) {
        ...
        function onTouchStart(event) {
            ...
            if (
                jQuery(event.target).parents(".wpb_gallery").length > 0 &&
                jQuery(event.target)
                .parents(".swiper-container")
                .attr("data-desktop-swipe") == "false" &&
                !Modernizr.touch
            ) {
                return false;
            }
            ...
            if (
                jQuery(event.target).parents(".swiper-container").find(".swiper-slide")
                .length == 1
            ) {
                return false;
            }
            ...
            if (
                jQuery(event.target)
                .parents(".swiper-container")
                .find(".swiper-slide.duplicate-transition").length > 0
            )
                return false;
            ...
            if (
                ...
                noSwipingSlide(event.target || event.srcElement)
            )
                return false;
        ...
        function onTouchMove(event) {
            ...
            if (!isTouchEvent || event.touches.length == 1) {
                ...
                _this.positions.current =
                    (_this.touches.current - _this.touches.start) * params.touchRatio +
        ...
        function noSwipingSlide(el) {
            ...
            if (!noSwiping &&
                el.className.indexOf(params.wrapperClass) > -1 &&
                el.className.indexOf(params.noSwipingClass) > -1
            )
        ...
        function swipeToPosition(newPosition, action, toOptions) {
            var speed =
                action == "to" && toOptions.speed >= 0 ? toOptions.speed : params.speed;
            ...
            if (
                action == "next" ||
                action == "prev" ||
                (action == "to" && toOptions.runCallbacks == true)
            )
            ...
            if (params.slidesPerView == "auto") {
                ...
                if (_this.activeIndex < 0) {
                    for (var i = 0; i < _this.slidesGrid.length - 1; i++) {
                        if (-position > _this.slidesGrid[i] &&
        ...
        _this.updatePagination = function(position) {
            ...
            if (params.paginationAsRange) {
                ...
                for (var i = 0; i < _this.visibleSlides.length; i++) {
                    var visIndex =
                        _this.slides.indexOf(_this.visibleSlides[i]) - indexOffset;
                ...
                for (i = 0; i < visibleIndexes.length; i++) {
                    if (pagers[visibleIndexes[i]])
                        pagers[visibleIndexes[i]].className +=
        ...
        _this.calcVisibleSlides = function(position) {
            ...
            for (var i = 0; i < _this.slides.length; i++) {
                ...
                if (params.slidesPerView == "auto")
                    _slideSize = isH ?
                    _this.h.getWidth(_this.slides[i], true) :
                    _this.h.getHeight(_this.slides[i], true);
        ...
        _this.createLoop = function() {
            ...
            //Grab Last Slides
            for (
                i = _this.slides.length - _this.loopedSlides; i < _this.slides.length; i++
            ) {
        ...
        _this.fixLoop = function() {
            if (_this.params.loop == true) {
                ...
                if (_this.activeIndex < _this.loopedSlides) {
                    newIndex =
                        _this.slides.length - _this.loopedSlides * 3 + _this.activeIndex;
                    _this.swipeTo(newIndex, 0, false);
                }
                //Fix For Positive Oversliding
                else if (
                    _this.activeIndex >
                    _this.slides.length - params.slidesPerView * 2
                ) {
 ...
 */
NectarSwiper.prototype.plugins.progress = function(a) {
    function b() {
    ...
    var d,
        ...
        f = {
            onFirstInit: function() {
                b(),
                    c({ x: a.getWrapperTranslate("x"), y: a.getWrapperTranslate("y") });
            },
            onInit: function() {
                b();
            },
...
jQuery(document).ready(function($) {
    ...
    var $captionTrans = 0;
    var $loading_bg_storage = $(".first-section .nectar-slider-loading").css(
        "background-image"
    );
    ...
    function transparentheaderLoadingCalcs() {
        if ($('body #header-outer[data-transparent-header="true"]').length > 0) {
            if ($("#page-header-bg").length === 0) {
                $(
                    ".nectar-slider-wrap.first-section .swiper-container .swiper-wrapper .swiper-slide"
                ).addClass("not-loaded");

                if (
                    $(".container-wrap .main-content > .row > div").find(
                        ".nectar-slider-wrap.first-section"
                    ).length > 0
                ) {
                    $(".container-wrap .main-content > .row > div")
                        .first()
                        .css("padding-top", "0");
                }
                ...
                if ($('#header-outer[data-remove-border="true"]').length === 0) {
                    if (
                        $('.first-section .nectar-slider-wrap[data-flexible-height="true"]')
                        .length === 0 &&
                        $('.first-section .nectar-slider-wrap[data-fullscreen="true"]')
                        .length === 0
                    ) {
                        $(".first-section .nectar-slider-loading").css({
                            top: $("#header-space").height(),
                            "background-position": "center " +
                                ($(".first-section .swiper-container").height() / 2 +
                                    15 -
                                    $("#header-space").height()) +
                                "px",
                        });
                        ...
                        $(
                            ".first-section .nectar-slider-wrap .nectar-slider-loading .loading-icon"
                        ).css({
                            opacity: "1",
                            height: $(".first-section .swiper-container").height() -
                                $("#header-space").height() +
                                "px",
                        });
                    } else {
                        $loading_bg_storage = $(
                            ".first-section .nectar-slider-loading"
    ...
    var $onMobileBrowser = navigator.userAgent.match(
    ...
    function prevArrowAnimation(e) {
        ...
        if ($(this).parents(".swiper-container").attr("data-loop") != "true") {
            if (
                ...
                if (
                    $(this).parents(".nectar-slider-wrap ").attr("data-transition") !=
                    "fade"
                ) {
                    $that = $(this);
        ...
        if (
            $(this).parents(".nectar-slider-wrap ").attr("data-transition") === "fade"
        ) {
            clearTimeout($timeout);
            $timeout = setTimeout(function() {
                $that.removeClass("inactive");
    ...
    function nextArrowAnimation(e) {
        ...
        var $slideNum = $(this)
            .parents(".swiper-container")
            .find(".swiper-wrapper > div").length;
        var $timeout;
    ...
    function prevArrowAnimationWithPreview(e) {
        ...
        $(this)
            .parents(".nectar-slider-wrap")
            .find(".swiper-slide-active")
            .prev(".swiper-slide")
            .removeClass("prev-high-z-index");
        $(this)
            .parents(".nectar-slider-wrap")
            .find(".swiper-slide-active")
            .stop()
            .removeClass("prev-move");
    ...
    function nextArrowAnimationWithPreview(e) {
        ...
        $(this)
            ...
            .find(".swiper-slide-active")
            .next(".swiper-slide")
            .removeClass("high-z-index");
        $(this)
            .parents(".nectar-slider-wrap")
            .find(".swiper-slide-active")
            .stop()
            .removeClass("next-move");
    ...
    function darkSlideNextMouseOver(currentSlider, activeIndex) {
        var $indexAdd =
            $(currentSlider).find(".swiper-container").attr("data-loop") === "true" ?
            2 :
            2;
    ...
    function prevArrowAnimationDirectional(e) {
            ...
            $that
                ...
                .css({
                    ...
                    left: parseInt(
                        ...
                        .find(".swiper-wrapper")
                        .css("left")
                    ) + $that.parents(".swiper-container").width(),
                });
            setTimeout(function() {
        ...
        if (
            $that.parents(".nectar-slider-wrap").is('[data-bg-animation="ken_burns"]')
        ) {
            $that
                .parents(".swiper-container")
                .find(".swiper-slide")
                .attr("data-ken-burns", "active");
    ...
    function nectarSliderMainInit() {
        ...
        $('.nectar-slider-wrap[data-full-width="boxed-full-width"]').each(
            function() {
                if (
        ...
        $(
            '.full-width-content .wpb_column .nectar-slider-wrap[data-full-width="true"]'
        ).attr("data-full-width", "false");
        ...
        if (
            $("body > #boxed").length === 0 &&
            $('.nectar-slider-wrap[data-full-width="true"]').parent().attr("id") !=
            "portfolio-extra" &&
            $('.nectar-slider-wrap[data-full-width="true"]').parents(
                '.post-area:not(".span_12")'
            ).length === 0
        ) {
            $(
                ...
                left: -(
                    ($windowWidth - $smoothSrollWidth) / 2 -
                    $(".main-content").width() / 2
                ),
                "margin-left": "0",
            });
            ...
            var $container =
                $("body > #boxed").length === 0 ? ".post-area" : ".container-wrap";
        ...
        $(".nectar-slider-wrap").each(function(i) {
            ...
            if (
                $bullets == "true" &&
                $(this).find(".swiper-wrapper > div").length > 1 &&
                $(this).attr("data-overall_style") != "directional"
            ) {
            ...
            $nectarSliders[i] = new NectarSwiper(
                "#" + $(this).attr("id") + " .swiper-container",
                $sliderOptions
            );
            $nectarSliders[i].swipeReset();
            ...
            if (
                ...
                if (
                    jQuery(this).find(
                        '.swiper-slide:nth-child(2) video source[type="video/webm"]'
                    ).length > 0 &&
                    ...
                    firstVideo = jQuery(this)
                        .find(".swiper-slide:nth-child(2) video")
                        .get(0);
                    ...
                    webmSource2 =
                        jQuery(this)
                        .find('.swiper-slide:last-child video source[type="video/webm"]')
                        .attr("src") +
                        "?id=" +
                        Math.ceil(Math.random() * 10000);
                    lastVideo = jQuery(this)
                        .find(".swiper-slide:last-child video")
                        .get(0);
                ...
                if (
                    jQuery(this).find(
                        '.swiper-slide:eq(-2) video source[type="video/webm"]'
                    ).length > 0 &&
                    jQuery(this).find(".swiper-container").attr("data-loop") === "true"
                ) {
                    webmSource =
                        jQuery(this)
                        .find('.swiper-slide:eq(-2) video source[type="video/webm"]')
                        .attr("src") +
                        "?id=" +
                        Math.ceil(Math.random() * 10000);
                    ...
                    webmSource2 =
                        jQuery(this)
                        .find(
                            '.swiper-slide:nth-child(1) video source[type="video/webm"]'
                        )
                        .attr("src") +
                        "?id=" +
                        Math.ceil(Math.random() * 10000);
                    lastVideo = jQuery(this)
                        .find(".swiper-slide:nth-child(1) video")
                        .get(0);
                    lastVideo.src = webmSource2;
                    lastVideo.load();
                }
            ...
            if (
                ...
                $("body").on(
                    ...
                    function() {
                        anime.remove(
                            ".slide-count i, .slider-next, .slider-prev, .slide-count span"
                        );
                ...
                //add slide counts
                var $slideCount =
                    $(this).find(".swiper-container").attr("data-loop") != "true" ?
                    $("#" + $(this).attr("id") + " .swiper-wrapper > div").length :
                    $("#" + $(this).attr("id") + " .swiper-wrapper > div").length - 2;

                //ie8
                if ($("html").hasClass("no-video"))
                    $slideCount = $(
                        "#" + $(this).attr("id") + " .swiper-wrapper > div"
                    ).length;

                $(
                    "#" + $(this).attr("id") + " .slider-prev .slide-count .slide-total"
                ).html($slideCount);
                $(
                    "#" + $(this).attr("id") + " .slider-next .slide-count .slide-total"
                ).html($slideCount);

                //prev
                $("body").off(
                    "click",
                    "#" + $(this).attr("id") + " .slider-prev",
                    prevArrowAnimation
                );
                $("body").on(
                    "click",
                    "#" + $(this).attr("id") + " .slider-prev", { i: i },
                    prevArrowAnimation
                );
                ...
                $("body").off(
                    "click",
                    "#" + $(this).attr("id") + " .slider-next",
                    nextArrowAnimation
                );
                $("body").on(
                    "click",
                    "#" + $(this).attr("id") + " .slider-next", { i: i },
                    nextArrowAnimation
                );
            }
            ...
            ////button with preview on hover
                ...
                $("body").on(
                    "mouseenter",
                    '.nectar-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-next:not(.stophover)',
                    function() {
                        $(this)
                            .parents(".nectar-slider-wrap")
                            .find(".swiper-slide-active")
                ...
                $("body").on(
                    "mouseenter",
                    '.nectar-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-prev:not(.stophover)',
                    function() {
                        $(this)
                            .parents(".nectar-slider-wrap")
                            .find(".swiper-slide-active")
                            .prev(".swiper-slide")
                            .addClass("prev-high-z-index");
                        $(this)
                            .parents(".nectar-slider-wrap")
                            .find(".swiper-slide-active")
                            .stop()
            ...
            if (
                $("#" + $(this).attr("id") + " .swiper-container").attr(
                    "data-bullet_style"
                ) === "scale"
            ) {
                $(
    ...
    function darkFirstSlide(slider) {
        if (
            slider.parents(".parallax_slider_outer").length > 0 &&
            slider.parents(".first-section").length > 0 &&
            slider.find('.swiper-slide-active[data-color-scheme="dark"]').length > 0
        ) {
            ...
            if (
                slider.find('.swiper-slide-active[data-color-scheme="dark"]').length >
                0 &&
                slider.parents(".first-section").length > 0 &&
                slider.is('[data-full-width="true"]')
            ) {
    ...
    function initialSlideLoad() {
        ...
        $(".swiper-wrapper").each(function() {
            if ($(this).find(".swiper-slide:nth-child(2) video").length > 0)
                $(this)
                .find(".swiper-slide:nth-child(2)")
                .addClass("first_video_slide");

            //ken burns start
            if (
                $(this).parents('.nectar-slider-wrap[data-bg-animation="ken_burns"]')
                .length > 0
            ) {
        ...
        $(".nectar-slider-wrap").each(function(i) {
            ...
            if ($(this).find(".swiper-slide-active video").length > 0) {
                ...
                if (
                    ($('#ajax-loading-screen[data-effect="center_mask_reveal"]').length >
                        0 &&
                        $that.parents(".parallax_slider_outer").length > 0 &&
            ...
            if (
                    ...
                    $(this).find("video")[0].onplay = function() {
                        ...
                        setTimeout(function() {
                            $videoSlide
                                ...
                                .find(".mobile-video-image")
                                .transition({ opacity: "0" }, 250);

                            anime({
                                targets: $videoSlide
                                    .parents(".swiper-slide")
                                    .find(".mobile-video-image")[0],
                                opacity: 0,
                                easing: "easeOutCubic",
                                duration: 250,
                            });
                ...
                $(".nectar-slider-wrap")
                    .find(".nectar-slider-loading")
                    .fadeOut(800, "easeInOutExpo");
                $(
                    ".nectar-slider-wrap.first-section .swiper-container .swiper-wrapper .swiper-slide"
                ...
                $(logoImg).on("load", function() {
                    if ($that.attr("data-overall_style") === "directional") {
                        $that
                            ...
                            .addClass("directional-trans-current");
                        onChangeStart($nectarSliders[i]);
                    }
                });
            } else {
    ...
    $(".parallax_slider_outer .nectar-slider-wrap .slide-bg-wrap").each(
        function() {
            if ($(this).parents(".top-level").length > 0) {
                if ($(this).find(".image-bg").length > 0) {
                    $(this)
                        .find(".image-bg")
                        .css({
                            height: Math.ceil($(this).parent().offset().top * 0.25) +
    ...
    function dynamicHeightSliders() {
        ...
        $(".nectar-slider-wrap").each(function() {
            ...
            if (window.innerWidth > 1000 && $("#ajax-content-wrap").length > 0) {
                $(
                    "body.material:not(\"[data-header-format='left-header']\") .parallax_slider_outer.first-section .nectar-slider-wrap"
                ).css("top", $("#ajax-content-wrap").offset().top);
            } else {
                $(
                    "body.material:not(\"[data-header-format='left-header']\") .parallax_slider_outer.first-section .nectar-slider-wrap"
                ).css("top", "0");
            ...
            if (
                ($(this).attr("data-fullscreen") === "true" &&
                    $(this).attr("data-full-width") === "true") ||
                ($(this).attr("data-fullscreen") === "true" &&
                    $(this).attr("data-full-width") === "boxed-full-width") ||
                ($(this).attr("data-fullscreen") === "true" &&
                    $(this).parents(".full-width-content").length > 0 &&
                ...
                if ($(this).parents("#nectar_fullscreen_rows").length === 0) {
                    ...
                    if (
                        ...
                        ($(this).parents(".wpb_row").length > 0 &&
                            $(this).parents(".wpb_row").hasClass("first-section") &&
                            $(this).index() === 0 &&
                            $(this).parents(".parallax_slider_outer").length === 0) ||
                        ($(this).parents(".wpb_row").length > 0 &&
                            $(this).parents(".wpb_row").hasClass("top-level") &&
                            $(this).parents(".parallax_slider_outer").length === 0)
                    ) {
                        //min height
                        $heightCal =
                            $(window).height() - $(this).offset().top + 2 <= $minHeight ?
                            $minHeight :
                            $(window).height() - $(this).offset().top + 2;
                        $(this).find(".swiper-container").attr("data-height", $heightCal);
                    }
                    //first parallax slider on page
                    else if (
                        ($(this).parents(".first-section").length > 0 &&
                            $(this).parents(".parallax_slider_outer").length > 0 &&
                            $(this).parents("#full_width_portfolio").length === 0) ||
                    ...
                    //all others
                        ...
                        var headerPadding = parseInt(
                            $("#header-outer").attr("data-padding")
                        );
                        var shrinkNum = 8;
                        if ($("#header-outer[data-shrink-num]").length > 0) {
                            shrinkNum = $("#header-outer").attr("data-shrink-num");
                        ...
                        var $resize =
                            ...
                            0 :
                            parseInt(shrinkNum) + headerPadding * 2;
                        var $headerSize =
                            $('#header-outer[data-permanent-transparent="false"]').length > 0 ?
                            $("#header-space").height() - $resize - 3 :
                            -3;
                        ...
                        //min height
                        $heightCal =
                            $(window).height() - $headerSize <= $minHeight ?
                            $minHeight :
                            $(window).height() - $headerSize;
                        $(this).find(".swiper-container").attr("data-height", $heightCal);
                    }
                    ...
                    if ($('#header-outer[data-remove-border="true"]').length === 0) {
                        if (
                            $('body #header-outer[data-transparent-header="true"]').length >
                            0 &&
                            $('.first-section .nectar-slider-wrap[data-fullscreen="true"]')
                            .length > 0 &&
                            ...
                            $(".first-section .nectar-slider-loading").css({
                                ...
                                "background-position": "center " +
                                    ($(window).height() / 2 + 15 - $("#header-space").height()) +
                                    "px",
                            });
            ...
            //flexible height
            if (
                $(this).attr("data-flexible-height") === "true" &&
                $(this).attr("data-fullscreen") !== "true"
            ) {
                ...
                var currentKey = $existingSliders.nectarGetKeyByValue(
                    $(this).attr("id")
                );
                    ...
                    if (!$parentCol.hasClass("vc_span12") &&
                        ...
                        if ($definedHeight * dif <= $minHeight) {
                            ...
                            $(this)
                                ...
                                .attr(
                                    "data-height",
                                    Math.ceil($parentColRatio * $definedHeight * dif)
                                );
                        }
                    }
                            ...
                            if ($('body[data-ext-responsive="true"]').length > 0) {
                                ...
                                if ($(this).has('[data-full-width="boxed-full-width"]')) {
                                    $(this)
                                        ...
                                        .attr(
                                            "data-height",
                                            Math.ceil($definedHeight * (1200 / 1600))
                                        );
                                }
                            }
                            ...
                            if ($('body[data-ext-responsive="true"]').length > 0) {
                                ...
                                if ($(this).has('[data-full-width="boxed-full-width"]')) {
                                    $(this)
                                        ...
                                        .attr(
                                            "data-height",
                                            Math.ceil($definedHeight * (980 / 1600))
                                        );
                                }
                            }
                        } else if (window.innerWidth < 1000 && window.innerWidth > 690) {
                            $heightCalc =
                                $definedHeight * (679 / 1600) <= $minHeight ?
                                $minHeight :
                                $definedHeight * (679 / 1600);
                            if ($(this).has('[data-full-width="boxed-full-width"]')) {
                                $(this)
                                    .find(".swiper-container")
                                    .attr("data-height", $minHeight);
                            }
                        } else if (window.innerWidth <= 690) {
                            $heightCalc =
                                $definedHeight * dif <= $minHeight ?
                                $minHeight :
                                $definedHeight * dif;
                            if ($(this).has('[data-full-width="boxed-full-width"]')) {
                                //mobile transparent
                ...
                //transparent header loading icon center
                if (
                    $('body #header-outer[data-transparent-header="true"]').length > 0 &&
                    $('.first-section .nectar-slider-wrap[data-flexible-height="true"]')
                    .length > 0
                ) {
                    $(".first-section .nectar-slider-loading").css({
                        "background-image": $loading_bg_storage,
                        "background-position": "center " +
                            (($definedHeight * dif) / 2 + 15 - $("#header-space").height()) +
                            "px",
                    });
    ...
    function sliderSize() {
        ...
        if (window.innerWidth < 1000 && window.innerWidth > 690) {
            ...
            //fullwidth sliders
            $(
                '.nectar-slider-wrap[data-full-width="true"]:not([data-fullscreen="true"],[data-flexible-height="true"])'
            ).each(function() {
            ...
            //column sliders
            $(
                '.nectar-slider-wrap[data-full-width="false"]:not([data-fullscreen="true"]):not([data-flexible-height="true"])'
            ).each(function() {
                currentKey = $existingSliders.nectarGetKeyByValue($(this).attr("id"));
                ...
                if (
                    ...
                    $(this).parents(".vc_span12").length > 0
                )
            ...
            //boxed sliders
            $(
                '.nectar-slider-wrap[data-full-width="boxed-full-width"]:not([data-flexible-height="true"]):not([data-fullscreen="true"])'
            ).each(function() {
                currentKey = $existingSliders.nectarGetKeyByValue($(this).attr("id"));
                $(this)
                    .find(".swiper-container")
            ...
            $(
                ...
                if ($(this).attr("data-flexible-height") != "true")
                    $(this)
                    .find(".swiper-container")
                    .attr("data-height", $sliderHeights[currentKey]);
            });

            //boxed sliders
            $(
                '.nectar-slider-wrap[data-full-width="false"]:not([data-fullscreen="true"]), .nectar-slider-wrap[data-full-width="boxed-full-width"]:not([data-flexible-height="true"]):not([data-fullscreen="true"])'
            ).each(function() {
                currentKey = $existingSliders.nectarGetKeyByValue($(this).attr("id"));
                if ($(this).attr("data-flexible-height") != "true")
                    $(this)
    ...
    function nsSliderContentResize() {
        ...
        for (var i = 0; i < $nectarSliders.length; i++) {
            ...
            if (
                $($nectarSliders[i].container).parent().attr("data-transition") &&
                $($nectarSliders[i].container).parent().attr("data-transition") ===
                "fade"
            ) {
                ...
                if ($(".nectar-slider-loading").css("display") === "none") {
                    $(
                        ".swiper-wrapper .swiper-slide.swiper-slide-active .content > *"
                    ).css({
                        opacity: 1,
        ...
        $(".nectar-slider-wrap").each(function(i) {
            if ($(this).css("visibility") != "hidden") {
                ...
                var $sliderHeight = parseInt(
                    $(this).find(".swiper-container").attr("data-height")
                );
                var $sliderMinHeight =
                    $(this).find(".swiper-container").is("[data-min-height]") &&
                    $(this).find(".swiper-container").attr("data-min-height").length > 0 ?
                    parseInt(
                        $(this).find(".swiper-container").attr("data-min-height")
                    ) :
                    0;
                ...
                var isFullWidthCompatible =
                    $(this).attr("data-full-width") === "true" ? "true" : "false";
                ...
                var $sliderWidth =
                    isFullWidthCompatible === "true" ?
                    $windowWidth - $smoothSrollWidth :
                    $(this).width();

                var lrPadding =
                    $(this).parents(".span_12").length > 0 &&
                    parseInt($(this).parents(".span_12").css("padding-left")) > 0 ?
                    true :
                    false;
                            ...
                            if ($(this).find(".video-wrap").length > 0) {
                                ...
                                if ($(this).attr("data-bg-alignment") === "center") {
                                    $(this)
                                        ...
                                        .scrollTop(
                                            ($(this).find("video").height() - $sliderHeight) / 2
                                        );
                                }
                                //align bottom
    ...
    function captionTransition(obj) {
        ...
        typeof obj == "undefined" ?
            ($containerClass = "div[id^=ns-id-]") :
            ($containerClass =
                "#" + $(obj.container).parents(".nectar-slider-wrap").attr("id"));

        var fromLeft = Math.abs(
            parseInt($($containerClass + " .swiper-wrapper").css("left"))
        );
        var currentSlide = Math.round(
            fromLeft / $($containerClass + " .swiper-slide").width()
        );
        var $slideNum = $($containerClass + ":first .swiper-wrapper > div").length;

        var captionTransString = $($containerClass).is("[data-caption-trans]") ?
            $($containerClass).attr("data-caption-trans") :
            "fade_in_from_bottom";
        ...
        if (
            ...
            captionTransString !== "reveal_title"
        ) {
            if (
                $(
                    $containerClass +
        ...
        if (!$("html").hasClass("no-video")) {
            if (captionTransString === "fade_in_from_bottom") {
                ...
                $($containerClass + " .swiper-slide .content > h1")
                    .stop(true, true)
                    .css({ opacity: "0" });
                $($containerClass + " .swiper-slide .content > h3")
                    .stop(true, true)
                    .css({ opacity: "0" });
                ...
                $($containerClass + " .swiper-slide .content h2 .word")
                    ...
                    .css({ opacity: "0" });
                $(
                    $containerClass + ' .swiper-slide .content h2 .word > [class*="char"]'
                ).css({ opacity: "0" });
                $(
                    $containerClass +
                    ' .swiper-slide .content h2 .word > [class*="char"] > span'
                ).css({ transform: "scale(0) translateZ(0)" });
        ...
        $($containerClass + " .swiper-slide").each(function() {
            if (
                $(this).find(".video-wrap video").length > 0 &&
                !$("html").hasClass("no-video") &&
                !$onMobileBrowser
            ) {
        ...
        $($containerClass + ' .swiper-slide:not(".swiper-slide-active")').each(
            function() {
        ...
        if (
            $($containerClass + " .swiper-container").attr("data-loop") === "true"
        ) {
            //webkit video fix
            if (
                $($containerClass + " .swiper-slide-active").index() + 1 == 2 &&
            ...
            if (
                $($containerClass + " .swiper-slide-active").index() + 1 ==
                $slideNum - 1 &&
                $($containerClass + " .swiper-slide-active video").length > 0 &&
                !$("html").hasClass("no-video") &&
                !$onMobileBrowser
            ...
            if (
                ...
                $($containerClass + " .swiper-slide:nth-child(2) video")
                    ...
                    .pause();
                if (
                    $($containerClass + " .swiper-slide:nth-child(2) video").get(0)
                    .currentTime != 0
                ) {
                    $($containerClass + " .swiper-slide:nth-child(2) video").get(
                        0
                    ).currentTime = 0;
                }
            }
        ...
        setTimeout(function() {
            ...
            if (
                $($containerClass).attr("data-button-styling") === "btn_with_preview"
            ) {
                $($containerClass + " .swiper-slide").addClass(
                    "prev-high-z-index-static"
                );
                $($containerClass + " .swiper-slide.swiper-slide-active").removeClass(
                    "prev-high-z-index-static"
                );
            }
        }, 175);
    ...
    function NSsplitLineText() {
        $(
            '.nectar-slider-wrap[data-caption-trans="reveal_title"] .content h2'
        ).each(function() {
            var storedCSSOpacity =
                $(this).parents(".swiper-slide-active").length > 0 &&
                $(this).find(".word").length > 0 ?
                $(this).find("> .word").css("opacity") :
                "0";
    ...
    function charming(element, options) {
        ...
        var classPrefix =
            options.classPrefix != null ? options.classPrefix : "char";
        var count = 1;
    ...
    function playVideoBG(nthChild, containerClass) {
        if (
            $(containerClass + " .swiper-slide:nth-child(" + nthChild + ")").find(
                ".video-wrap video"
            ).length > 0
        ) {
            ...
            if (!$(containerClass + " .swiper-slide:nth-child(" + nthChild + ")")
    ...
    function slideContentPos() {
        $(".swiper-wrapper").each(function() {
            var $sliderHeight = parseInt(
                $(this).parents(".swiper-container").attr("data-height")
            );
            var $minimumHeight = $(this)
                .parents(".swiper-container")
                .css("min-height") ?
                parseInt($(this).parents(".swiper-container").css("min-height")) :
                0;
            ...
            if (
                ...
                $transparentHeader != 0 &&
                $('#header-outer[data-remove-border="true"]').length > 0
            ) {
            ...
            if (
                ($(this).parents(
                        '.swiper-container[data-bullet_position="right"][data-bullets="true"]'
                    ).length > 0 &&
                    $transparentHeader > 0) ||
                ($(this).parents(
                        '.swiper-container[data-bullet_position="left"][data-bullets="true"]'
                    ).length > 0 &&
                    $transparentHeader > 0)
            ) {
                var secondaryHeaderHeight =
                    $("#header-secondary-outer").length > 0 ?
                    $("#header-secondary-outer").height() :
                    0;
                $(this)
                    .parents(".swiper-container")
            ...
            $(this)
                ...
                .each(function() {
                    ...
                    if ($(this).attr("data-y-pos") === "top" && window.innerWidth > 690) {
                        ...
                        var $topHeight =
                            $transparentHeader > 0 ?
                            $transparentHeader + secondaryHeaderHeight + 60 :
                            60;
                        $(this)
                            .find(".content")
                            .css("top", $topHeight + "px");
                    } else if (
                        $(this).attr("data-y-pos") === "middle" ||
                        window.innerWidth <= 690
                    ) {
                        $(this)
                            .find(".content")
                            .css(
                                "top",
                                ($sliderHeight + $transparentHeader) / 2 -
                                $contentHeight2 / 2 +
                                "px"
                            );
                    } else {
    ...
    function showSliderControls() {
        $(
            ".swiper-container .slider-prev, .swiper-container .slider-next, .slider-pagination"
        ).animate({ opacity: 1 }, 550, "easeOutCubic");
    }
    ...
    function sliderLoadIn(slider, index) {
        ...
        if (
            slider.find(
                '.swiper-container[data-bullet_style="see_through_ar_visualized"][data-bullets="true"]'
            ).length > 0
        ) {
        ...
        sliderLoadedLength++;
        if (
            $(".tabbed").find(".swiper-container").length > 0 &&
            sliderLoadedLength == sliderLength
        ) {
            setTimeout(function() {
    ...
    function autorotateInit(slider, num) {
        ...
        if (
            typeof $autoplayVal != "undefined" &&
            $autoplayVal.length != "0" &&
            parseInt($autoplayVal)
        ) {
    ...
    function nectarSlideRotateInit(slider, interval, sliderNum) {
        ...
        $(
            ...
            " a.slider-next, #" +
            slider.attr("id") +
            " .slider-pagination span:not(.swiper-active-switch)"
        ).on("click", function() {
            nectarSlideRotateReset(
                sliderClosure,
                sliderAutoplayCountClosure,
                intervalClosure,
                sliderNumClosure
            );
        });
    ...
    function nectarSlideRotateReset(
        slider,
        sliderAutoplayCount,
        interval,
        sliderNum
        ...
        slider =
            typeof slider.activeIndex === "undefined" ?
            slider :
            $(slider.container).parent();

        sliderAutoplayCount =
            typeof sliderAutoplayCount !== "undefined" &&
            typeof sliderAutoplayCount === "number" ?
            sliderAutoplayCount :
            "unknown";
        ...
        if (sliderAutoplayCount === "unknown") {
            $.each(autoplay, function(k, v) {
                if (
                    $("body").find("#" + v.nectarSliderID).length > 0 &&
                    v.nectarSliderID == $(slider).attr("id")
                ) {
        ...
        if (sliderAutoplayCount !== "unknown") {
            clearInterval(
                autoplay[$("#" + slider.attr("id")).attr("autoplay-id")].interval
            );
    ...
    function nectarSlideRotateResetTouch(slider) {
        ...
        if (
            resetTouchIndexLast == "unknown" &&
            $(slider.container).is('[data-loop="true"]')
        ) {
        ...
        if (
            $(slider.container).is(
                '[data-bullets="true"][data-bullet_style="see_through_ar_visualized"]'
            ) &&
            resetTouchIndex == resetTouchIndexLast
        ) {
            ...
            setTimeout(function() {
                $(slider.container)
                    .find(
                        ".slider-pagination > span:nth-child(" + (dotIndexStored + 1) + ")"
                    )
                    .addClass("ar-vis");
            }, 50);
        }
    ...
    function nectarSlideRotate(slider, sliderNum) {
        ...
        //non looped
        if (
            $nectarSliders[sliderNum].activeIndex + 1 <
            $(slider).find(".swiper-wrapper > div.swiper-slide").length
        ) {
            ...
            if ($(slider).attr("data-overall_style") != "directional") {
                ...
                //directional based
                $($nectarSliders[sliderNum].container)
                    .find(".slider-next")
                    .trigger("click");
            }
        } else {
            //looped sliders
            if (
                $(slider).find(".swiper-container").is("[data-loop]") &&
                $(slider).find(".swiper-container").attr("data-loop") === "true"
            ) {
                //classic style
                if ($(slider).attr("data-overall_style") != "directional") {
                    $nectarSliders[sliderNum].swipeNext();
            ...
            //regular sliders
                ...
                if ($(slider).attr("data-overall_style") != "directional") {
                    ...
                    $(slider)
                        .find(".swiper-container")
                        .addClass("directional-trans-prev");
                    $nectarSliders[sliderNum].swipeTo(0, 550);
                    var $timeout2;
                    clearTimeout($timeout2);
                    $timeout2 = setTimeout(function() {
    ...
    function clearAutoplay(e) {
        var $autoplayVal = $("#" + $(e.container).parent().attr("id")).attr(
            "data-autorotate"
        );
        ...
        if (
            ...
            clearInterval(
                autoplay[
                    $("#" + $(e.container).parent().attr("id")).attr("autoplay-id")
                ].interval
            );
        }
    }
    ...
    function onChangeStart(e) {
        ...
        var $activeIndex =
            $($obj.container).attr("data-loop") === "true" ?
            $obj.activeIndex + 1 :
            $obj.activeIndex + 1;
        var $activeIndex2 =
            $($obj.container).attr("data-loop") === "true" ?
        ...
        //dark slide header
        if (
            $($obj.container).parent().attr("data-overall_style") !== "directional"
        ) {
            if (
                ($($obj.container).parents(".first-section").length > 0 &&
                    $($obj.container).find(
                        '.swiper-slide-active[data-color-scheme="dark"]'
                    ).length > 0) ||
                ($("#nectar_fullscreen_rows").length > 0 &&
                    $($obj.container).find(
                        '.swiper-slide-active[data-color-scheme="dark"]'
        ...
        //add slide counts
        $($obj.container)
            .find(".slider-prev .slide-count .slide-current")
            .html($activeIndex2);
        $($obj.container)
            .find(".slider-next .slide-count .slide-current")
            .html($activeIndex2);
        ...
        if ($($obj.container).attr("data-loop") === "true") {
            ...
            if ($($obj.container).find(".swiper-slide-active").index() + 1 == 1) {
                $($obj.container)
                    .find(
                        ".slider-next .slide-count .slide-current, .slider-prev .slide-count .slide-current"
                    )
                    .html($slideNum - 2);
            }
            //duplicate last slide
            else if (
                $($obj.container).find(".swiper-slide-active").index() + 1 ==
                $slideNum
            ) {
                $($obj.container)
                    .find(
        ...
        if ($obj.activeIndex >= 10) {
            $($obj.container)
                .find(".slider-next .slide-count .slide-current")
                .addClass("double-digits");
        } else {
            $($obj.container)
                .find(".slider-next .slide-count .slide-current")
                .removeClass("double-digits");
        }

        //don't allow swiping on duplicate transition
        if ($($obj.container).attr("data-loop") === "true") {
            if (
                ($obj.previousIndex == 1 && $obj.activeIndex == 0) ||
                ($obj.previousIndex == $slideNum - 2 &&
                    $obj.activeIndex == $slideNum - 1)
            ) {
        ...
        if (
            $($obj.container).parent().is('[data-bg-animation="ken_burns"]') &&
            $($obj.container).parents(
                '.nectar-slider-wrap[data-overall_style="directional"]'
            ).length === 0
        ) {
            $($obj.container).find(".swiper-slide").addClass("ken-burns");
            clearTimeout(slideAnimationQueues[sliderIndex].kenBurnsInterval);
            slideAnimationQueues[sliderIndex].kenBurnsInterval = setTimeout(
                function() {
                    $($obj.container)
                        .find('.swiper-slide:not(".swiper-slide-active")')
                        .removeClass("ken-burns");
                },
                600
            );
        }
        ...
        var nsTimeout =
            $($obj.container).parents('.nectar-slider-wrap[data-transition="fade"]')
            .length > 0 ?
            350 :
            525;
        ...
        if (
            ...
            slideAnimationQueues[sliderIndex].captionInterval = setTimeout(
                function() {
                    $animating = false;
    ...
    function sliderParallaxUpdateHeight() {
        $sliderHeight = parseInt(
            $(".parallax_slider_outer.first-section .swiper-container").attr(
                "data-height"
            )
        );
    }
    ...
    function sliderParallaxInit() {
        ...
        if (!$onMobileBrowser) {
            ...
            if ($(".project-title.parallax-effect").length > 0) {
                ...
                $(".swiper-container .slider-prev, .swiper-container .slider-next").css(
                    "margin-top",
                    "-28px"
                );
            }
            ...
            if ($(".demo_store").length > 0)
                $(".project-title.parallax-effect").css("margin-top", "-25px");
    ...
    $(
        ".portfolio-items a.pp:contains(Video), .swiper-container .buttons a.pp"
    ).on("click", function() {
    ...
    $.cssHooks.backgroundColor = {
        get: function(elem) {
            ...
            if (bg.search("rgb") == -1) {
                ...
                if (bg) {
                    return (
                        "#" + hexConvert(bg[1]) + hexConvert(bg[2]) + hexConvert(bg[3])
                    );
                }
            }
        },
    ...
    $(".swiper-slide.external-full-link a.entire-slide-link").attr(
        "target",
        "_blank"
    );
    $(".swiper-slide.external-button-1 .buttons > div:nth-child(1) a").attr(
        "target",
        "_blank"
    );
    $(".swiper-slide.external-button-2 .buttons > div:nth-child(2) a").attr(
        "target",
        "_blank"
    );
    ...
    $("body").on("click", ".slider-down-arrow", function() {
        ...
        var $offset =
            $currentSlider.parents(".first-section").length === 0 ||
            $('#header-outer[data-transparent-header="true"]').length === 0 ?
            $currentSlider.offset().top :
            0;
        ...
        if ($('body[data-permanent-transparent="1"]').length === 0) {
            ...
            if (!$("body").hasClass("mobile")) {
                ...
                if ($('body[data-hhun="1"]').length > 0) {
                    ...
                    if ($('#header-outer[data-condense="true"]').length > 0) {
                        ...
                        $headerNavSpace =
                            ...
                            parseInt($secondaryHeaderHeight);
                        ...
                        $("body,html")
                            .stop()
                            .animate({
                                    scrollTop: parseInt($topDistance - $("#header-space").height()) +
                                        parseInt(shrinkNum) +
                                        headerPadding * 2 +
                                        $offset +
                                        2 +
                ...
                var $scrollPos =
                    ...
                    $("#header-space").height() +
                    parseInt($currentSlider.offset().top) +
                    2 :
                    parseInt($topDistance) +
                    parseInt($currentSlider.offset().top) +
                    2;
            ...
            $("body,html")
                .stop()
                .animate({
                        scrollTop: parseInt($topDistance) +
                            parseInt($currentSlider.offset().top) +
                            2,
                    },
                    1000,
