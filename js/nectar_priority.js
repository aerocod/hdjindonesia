...
if (
    ...
    headerEl != null &&
    typeof headerSpaceEl != "undefined" &&
    headerSpaceEl != null &&
...
jQuery(function($) {
    ...
    function fullscreenHeightCalc() {
        ...
        nectarPageHeader.css(
            "height",
            parseInt(window.innerHeight) - parseInt(pageHeaderOffset) + "px"
        );
    }

    if (
        using_mobile_browser &&
        $("#page-header-bg.fullscreen-header").length > 0
    ) {
    ...
    function portfolioFullScreenSliderCalcs() {
        var $bodyBorderSize =
            $(".body-border-top").length > 0 && $(window).width() > 1000 ?
        ...
        $(".nectar_fullscreen_zoom_recent_projects").each(function() {
            if ($(this).parents(".first-section").length > 0) {
                $(this).css(
                    "height",
                    $(window).height() - $(this).offset().top - $bodyBorderSize
                );
            } else {
    ...
    if (
        using_mobile_browser &&
        $(".nectar_fullscreen_zoom_recent_projects").length > 0
    ) {
    ...
    function centeredNavBottomBarReposition() {
        ...
        if (
            ...
            $('#header-outer[data-menu-bottom-bar-align="left"]').length == 0
        ) {
